...
describe('TriangleClassifier', function() {
  ...
  it('classifies as isosceles 4,2,2', function() {
    var result = new TriangleClassifier().classify(4,2,2);
    expect(result).toEqual('isosceles');
  });

  it('classifies as isosceles 2,2,4', function() {
    var result = new TriangleClassifier().classify(2,2,4);
    expect(result).toEqual('isosceles');
  });
